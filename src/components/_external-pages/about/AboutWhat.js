        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6} lg={5}>
            ...
            <MotionInView variants={varFadeInRight}>
              ...
              >
                Our solution allows buyers of new products from authorized dealers and or Manufacturers to create a
                token / smart contract of ownership, which is transferable on the sale of these goods through our
                marketplace or personal sales.
              </Typography>
            </MotionInView>
